...
public class Assembler {
    ...
    static String instructionToBinary(String first, String[] tail) {
        ...
        if (first.equalsIgnoreCase("AND")) {
            ...
            binary += registerToBinary(tail[0]);
            binary += registerToBinary(tail[1]);
            binary += decimalToBinary(Integer.parseInt(tail[2]), 8);
        } else if (first.equalsIgnoreCase("SUB")) {
            binary += "0010";
            binary += registerToBinary(tail[0]);
            binary += registerToBinary(tail[1]);
            binary += registerToBinary(tail[2]);
            binary += "0000";
        } else if (first.equalsIgnoreCase("SUBI")) {
            binary += "0011";
            binary += registerToBinary(tail[0]);
            binary += registerToBinary(tail[1]);
            binary += decimalToBinary(Integer.parseInt(tail[2]), 8);
            ...
            binary += "1010";
            binary += decimalToBinary(Integer.parseInt(tail[0]), 16);
        } else if (first.equalsIgnoreCase("LD")) {
            binary += "1011";
            binary += registerToBinary(tail[0]);
            binary += decimalToBinary(Integer.parseInt(tail[1]), 12);
        } else if (first.equalsIgnoreCase("ST")) {
            binary += "1100";
            binary += registerToBinary(tail[0]);
            binary += decimalToBinary(Integer.parseInt(tail[1]), 12);
        } else if (first.equalsIgnoreCase("PUSH")) {
            binary += "1101";
            binary += registerToBinary(tail[0]);
            binary += "000000000000";
        } else if (first.equalsIgnoreCase("POP")) {
            binary += "1110";
            binary += registerToBinary(tail[0]);
            binary += "000000000000";
        } else if (first.equalsIgnoreCase("BE")) {
            binary += "1111";
            binary += registerToBinary(tail[0]);
            binary += registerToBinary(tail[1]);
            binary += decimalToBinary(Integer.parseInt(tail[2]), 7);
            binary += "1";
        } else if (first.equalsIgnoreCase("BNE")) {
            binary += "1111";
            binary += registerToBinary(tail[0]);
            binary += registerToBinary(tail[1]);
            binary += decimalToBinary(Integer.parseInt(tail[2]), 7);
